...
public class MybatisGroupBuyDao implements GroupBuyDao {
	...
	public int updateParticipants(GroupBuy groupBuy) throws DataAccessException{
		return groupBuyMapper.updateParticipants(groupBuy);
	}
	...
	public List<GroupBuy> getGroupBuyListByKeyword(String keyword) {
		return groupBuyMapper.getGroupBuyListByKeyword(keyword);
	}
