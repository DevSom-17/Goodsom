        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              Computer Science<br>
              17's Project <br><br>
              <strong>Email:</strong> goodsom2020@gmail.com<br>
            </p>
          </div>
...
<!--           </div> -->
          ...
          <div class="col-lg-3 col-md-6 footer-links">
              ...
              <ul>
	              ...
	              <li><i class="bx bx-chevron-right"></i> <a href="https://github.com/yejineer">Yejin Lee</a></li>
...
<!--           </div> -->
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="mr-md-auto text-center text-md-left">
        <div class="copyright">
          &copy; Copyright <strong><span>Goodsom</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
