							...
							<div class="col-md-12">
										...
										<div class="portfolio-wrap" style="padding: 35px">
											<div style="width: 100%">
												<div class="portfolio-info">
													...
													<c:forEach var="lineGroupBuy"
														items="${order.lineGroupBuys}" varStatus="status">
														<br />
														<span class="meta d-inline-block mb-3"> <span
															class="mx-2"> 옵션 : ${lineGroupBuy.selectOption}</span>
															&nbsp;&nbsp; <span class="mx-2"> 수량 :
																${lineGroupBuy.quantity}개</span> &nbsp;&nbsp; <span
															class="mx-2"> 금액 : ${lineGroupBuy.unitPrice}원</span>
														</span>
													</c:forEach>
													<div class="d-flex">
										...
										<div class="portfolio-wrap" style="padding: 35px">
											<div style="width: 100%">
												<div class="portfolio-info">
													...
													<span class="meta d-inline-block mb-3"> <span
														class="mx-2"> 금액 : ${order.totalPrice}원</span>
														&nbsp;&nbsp;<br>
													</span>
												</div>
												<div class="d-flex">
								...
								<div class="container">
									<a class="btn btn-primary py-3 px-5"
										href="<c:url value='/mypage/list.do'>
